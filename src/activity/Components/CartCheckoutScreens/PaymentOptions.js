...
const PaymentOptions = (props) => 
{
    ...
    const redeemRewards = () =>{
        ...
        fetch("https://shanya.ca/admin/api/redeem_rewards", requestOptions)
    ...
    const fetchCouponCodes = () => {
        ...
        fetch("https://shanya.ca/admin/api/couponlist", requestOptions)
          .then(response => response.json())
          .then(async result => {
              console.log(result);
    ...
    const handleSubmitCupon = (coupon_code) =>{
        ...
        fetch("https://shanya.ca/admin/api/apply_coupon", requestOptions)
          .then(response => response.json())
          .then(async result => {
    ...
    const _getPaymentMethod = async () => {
        let response = await fetch(
            'https://shanya.ca/admin/api/pymnt_via'
        );
    ...
    const _getRewardLines= (cart_id) => {
        ...
        fetch("https://shanya.ca/admin/api/rewardlines", requestOptions)
          .then(response => response.json())
          .then(result =>{ 
    ...
    const handleCheckOutAPI = (method, status) => {
        ...
        fetch("https://shanya.ca/admin/api/checkout", requestOptions)
          .then(response => response.json())
          .then(result => {
