...
const Homescreen = (props) => {
  ...
  const readUserDetails = (userId) => {
    ...
    fetch('https://shanya.ca/admin/api/myprofile', {
      ...
      fetch("https://shanya.ca/admin/api/currency", {method: 'GET'})
      .then(response => response.json())
      .then(result => {
        if (result.status === '1'){
  ...
  _getHomePageDataAsync = async () => {
    ...
    fetch('https://shanya.ca/admin/api/homepage', {
      method: 'POST',
      body: formBody,
      headers: {
        //Header Defination
      ...
      .then((responseJson) => {
        ...
        else 
        {
          ...
          fetch("https://shanya.ca/admin/api/delivery_info", requestOptions)
            .then(response => response.json())
      ...
      _getProductDataAsync = async (catID, title,i) => {
        ...
        new Promise((resolve) => {
          ...
          fetch('https://shanya.ca/admin/api/cat_product', {
            method: 'POST',
            body: formBody,
            headers: {
              //Header Defination
                          ...
                          <TouchableOpacity key={productData.product_id} onPress={() => _getProductItem(productData,index)}>
                              <View style={styles.trendingCategoryView}>
                                  <View style={{flex: 1}}>
                                      <Image
                                        source={{
                                          uri:'https://shanya.ca/admin/' + productData.product_image,
                                        }}
            ...
            <View>
              <ScrollView 
                ...
                {topCategories.map((topCategory,i) => (
                  ...
                  //       <Image style={{flex:2,width:50,height:50,borderRadius:50,alignSelf:"center",marginTop:5}} source={{uri:'https://shanya.ca/admin/' + topCategory.image}}/> 
              ...
              > 
                {banner1.map(bannerPhoto => (
                  <Image key={bannerPhoto.banner_id} source={{
                    ...
                    uri:"https://shanya.ca/admin/"+ bannerPhoto.banner_image,
                    }}
                                      ...
                                      <View style={styles.trendingView}>
                                          <View style={{flex: 1}}>
                                            <Image
                                              source={{
                                                uri:
                                                  'https://shanya.ca/admin/' + trendingItem.product_image,
                                              }}
                                              style={[styles.trendingImageStyle]}
                                            />
                                    ...
                                    <View style={styles.trendingView}>
                                      <View style={{flex: 1}}>
                                        <Image
                                          source={{
                                            uri:
                                            'https://shanya.ca/admin/' + featuredItem.product_image,
                                          }}
                                          style={styles.trendingImageStyle}
                                        />
                                  ...
                                  <View style={styles.trendingView}>
                                    <View style={{flex: 1}}>
                                      <Image
                                        source={{
                                          uri:
                                          'https://shanya.ca/admin/' + recommendedItem.product_image,
                                        }}
                                        style={styles.trendingImageStyle}
                                      />
              ...
              <ScrollView 
                ...
                {banner2.map(bannerPhoto2 => (
                  <Image key={bannerPhoto2.sec_banner_id} source={{
                    //banner: bannerPhoto.banner_image,
                    uri:"https://shanya.ca/admin/"+ bannerPhoto2.banner_image,
                    }}
                    style={[styles.imageStyle]}
                  />
                ))}
